...
class Assets {
    ...
    static fromJSON(obj) {
        return new Assets({
            feesReserves: new bn_js_1.default(obj.feesReserves),
            owned: new bn_js_1.default(obj.owned),
            locked: new bn_js_1.default(obj.locked),
            guaranteedUsd: new bn_js_1.default(obj.guaranteedUsd),
            globalShortSizes: new bn_js_1.default(obj.globalShortSizes),
            globalShortAveragePrices: new bn_js_1.default(obj.globalShortAveragePrices),
        });
    }
    toEncodable() {
