...
class PricingParams {
    ...
    static fromJSON(obj) {
        return new PricingParams({
            tradeSpreadLong: new bn_js_1.default(obj.tradeSpreadLong),
            tradeSpreadShort: new bn_js_1.default(obj.tradeSpreadShort),
            swapSpread: new bn_js_1.default(obj.swapSpread),
            maxLeverage: new bn_js_1.default(obj.maxLeverage),
            maxGlobalLongSizes: new bn_js_1.default(obj.maxGlobalLongSizes),
            maxGlobalShortSizes: new bn_js_1.default(obj.maxGlobalShortSizes),
        });
    }
    toEncodable() {
...
exports.PricingParams = PricingParams;
//# sourceMappingURL=PricingParams.js.map