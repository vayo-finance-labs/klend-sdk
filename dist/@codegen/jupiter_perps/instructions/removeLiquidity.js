...
exports.DISCRIMINATOR = Buffer.from([80, 85, 209, 72, 24, 206, 177, 108]);
exports.layout = borsh.struct([
    types.RemoveLiquidityParams.layout("params"),
]);
function removeLiquidity(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
