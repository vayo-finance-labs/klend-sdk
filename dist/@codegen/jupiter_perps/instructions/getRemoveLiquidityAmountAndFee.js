...
exports.getRemoveLiquidityAmountAndFee = getRemoveLiquidityAmountAndFee;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const types = __importStar(require("../types")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([194, 226, 233, 102, 14, 21, 196, 7]);
exports.layout = borsh.struct([
    types.GetRemoveLiquidityAmountAndFeeParams.layout("params"),
]);
function getRemoveLiquidityAmountAndFee(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
    ...
    const len = exports.layout.encode({
        params: types.GetRemoveLiquidityAmountAndFeeParams.toEncodable(args.params),
    }, buffer);
    const data = Buffer.concat([exports.DISCRIMINATOR, buffer]).slice(0, 8 + len);
    const ix = { accounts: keys, programAddress, data };
    return ix;
}
//# sourceMappingURL=getRemoveLiquidityAmountAndFee.js.map