...
exports.decreasePositionPostSwap = decreasePositionPostSwap;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const types = __importStar(require("../types")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([75, 246, 208, 7, 203, 66, 106, 91]);
exports.layout = borsh.struct([
    types.DecreasePositionPostSwapParams.layout("params"),
]);
function decreasePositionPostSwap(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=decreasePositionPostSwap.js.map