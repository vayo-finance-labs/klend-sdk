...
exports.DISCRIMINATOR = Buffer.from([253, 234, 128, 104, 192, 188, 45, 91]);
exports.layout = borsh.struct([
    types.IncreasePositionParams.layout("params"),
]);
function increasePosition(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
