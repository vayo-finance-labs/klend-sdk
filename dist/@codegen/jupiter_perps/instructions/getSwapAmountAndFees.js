...
exports.getSwapAmountAndFees = getSwapAmountAndFees;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const types = __importStar(require("../types")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([247, 121, 40, 99, 35, 82, 100, 32]);
exports.layout = borsh.struct([
    types.GetSwapAmountAndFeesParams.layout("params"),
]);
function getSwapAmountAndFees(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=getSwapAmountAndFees.js.map