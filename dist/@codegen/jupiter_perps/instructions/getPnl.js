...
exports.DISCRIMINATOR = Buffer.from([106, 212, 3, 250, 195, 224, 64, 160]);
exports.layout = borsh.struct([
    types.GetPnlAndFeeParams.layout("params"),
]);
function getPnl(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=getPnl.js.map