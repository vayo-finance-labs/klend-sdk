...
exports.getExactOutSwapAmountAndFees = getExactOutSwapAmountAndFees;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const types = __importStar(require("../types")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([196, 32, 218, 118, 151, 233, 43, 56]);
exports.layout = borsh.struct([
    types.GetExactOutSwapAmountAndFeesParams.layout("params"),
]);
function getExactOutSwapAmountAndFees(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=getExactOutSwapAmountAndFees.js.map