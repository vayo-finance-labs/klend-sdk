...
exports.getLiquidationState = getLiquidationState;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const types = __importStar(require("../types")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([127, 126, 199, 117, 90, 89, 29, 50]);
exports.layout = borsh.struct([
    types.GetLiquidationStateParams.layout("params"),
]);
function getLiquidationState(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=getLiquidationState.js.map