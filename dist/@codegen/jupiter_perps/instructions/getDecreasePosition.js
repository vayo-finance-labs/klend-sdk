...
exports.getDecreasePosition = getDecreasePosition;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const types = __importStar(require("../types")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([106, 31, 146, 195, 103, 108, 48, 250]);
exports.layout = borsh.struct([
    types.GetDecreasePositionParams.layout("params"),
]);
function getDecreasePosition(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=getDecreasePosition.js.map