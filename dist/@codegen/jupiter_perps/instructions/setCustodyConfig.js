...
exports.setCustodyConfig = setCustodyConfig;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const types = __importStar(require("../types")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([133, 97, 130, 143, 215, 229, 36, 176]);
exports.layout = borsh.struct([
    types.SetCustodyConfigParams.layout("params"),
]);
function setCustodyConfig(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=setCustodyConfig.js.map