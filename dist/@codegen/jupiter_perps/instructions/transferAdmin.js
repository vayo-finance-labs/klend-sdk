...
exports.DISCRIMINATOR = Buffer.from([42, 242, 66, 106, 228, 10, 111, 156]);
exports.layout = borsh.struct([
    types.TransferAdminParams.layout("params"),
]);
function transferAdmin(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=transferAdmin.js.map