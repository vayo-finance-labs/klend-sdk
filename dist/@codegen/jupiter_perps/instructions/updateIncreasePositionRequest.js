...
exports.updateIncreasePositionRequest = updateIncreasePositionRequest;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const types = __importStar(require("../types")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([100, 110, 83, 102, 86, 7, 105, 157]);
exports.layout = borsh.struct([
    types.UpdateIncreasePositionRequestParams.layout("params"),
]);
function updateIncreasePositionRequest(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
    ...
    const len = exports.layout.encode({
        params: types.UpdateIncreasePositionRequestParams.toEncodable(args.params),
    }, buffer);
    const data = Buffer.concat([exports.DISCRIMINATOR, buffer]).slice(0, 8 + len);
    const ix = { accounts: keys, programAddress, data };
    return ix;
}
//# sourceMappingURL=updateIncreasePositionRequest.js.map