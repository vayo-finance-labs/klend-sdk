...
exports.increasePositionPreSwap = increasePositionPreSwap;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const types = __importStar(require("../types")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([26, 136, 225, 217, 22, 21, 83, 20]);
exports.layout = borsh.struct([
    types.IncreasePositionPreSwapParams.layout("params"),
]);
function increasePositionPreSwap(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=increasePositionPreSwap.js.map