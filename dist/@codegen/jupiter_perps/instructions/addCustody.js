...
exports.addCustody = addCustody;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const types = __importStar(require("../types")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([247, 254, 126, 17, 26, 6, 215, 117]);
exports.layout = borsh.struct([
    types.AddCustodyParams.layout("params"),
]);
function addCustody(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=addCustody.js.map