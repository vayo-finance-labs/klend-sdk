...
exports.setPerpetualsConfig = setPerpetualsConfig;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const types = __importStar(require("../types")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([80, 72, 21, 191, 29, 121, 45, 111]);
exports.layout = borsh.struct([
    types.SetPerpetualsConfigParams.layout("params"),
]);
function setPerpetualsConfig(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=setPerpetualsConfig.js.map