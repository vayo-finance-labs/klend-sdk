...
exports.DISCRIMINATOR = Buffer.from([57, 125, 21, 59, 200, 137, 179, 108]);
exports.layout = borsh.struct([
    types.DecreasePositionParams.layout("params"),
]);
function decreasePosition(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        { address: accounts.keeper.address, role: 2, signer: accounts.keeper },
        (0, kit_1.isSome)(accounts.keeperAta)
