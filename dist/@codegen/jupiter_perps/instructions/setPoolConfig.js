...
exports.setPoolConfig = setPoolConfig;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const types = __importStar(require("../types")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([216, 87, 65, 125, 113, 110, 185, 120]);
exports.layout = borsh.struct([
    types.SetPoolConfigParams.layout("params"),
]);
function setPoolConfig(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=setPoolConfig.js.map