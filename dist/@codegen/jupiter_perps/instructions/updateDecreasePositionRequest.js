...
exports.updateDecreasePositionRequest = updateDecreasePositionRequest;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const types = __importStar(require("../types")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([69, 44, 72, 173, 62, 20, 177, 146]);
exports.layout = borsh.struct([
    types.UpdateDecreasePositionRequestParams.layout("params"),
]);
function updateDecreasePositionRequest(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
    ...
    const len = exports.layout.encode({
        params: types.UpdateDecreasePositionRequestParams.toEncodable(args.params),
    }, buffer);
    const data = Buffer.concat([exports.DISCRIMINATOR, buffer]).slice(0, 8 + len);
    const ix = { accounts: keys, programAddress, data };
    return ix;
}
//# sourceMappingURL=updateDecreasePositionRequest.js.map