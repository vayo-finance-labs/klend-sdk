...
exports.setCustodyGlobalLimit = setCustodyGlobalLimit;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const types = __importStar(require("../types")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([94, 82, 154, 177, 193, 205, 141, 76]);
exports.layout = borsh.struct([
    types.SetCustodyGlobalLimitParams.layout("params"),
]);
function setCustodyGlobalLimit(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=setCustodyGlobalLimit.js.map