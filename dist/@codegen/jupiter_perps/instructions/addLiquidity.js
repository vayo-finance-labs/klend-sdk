...
exports.DISCRIMINATOR = Buffer.from([181, 157, 89, 67, 143, 182, 52, 72]);
exports.layout = borsh.struct([
    types.AddLiquidityParams.layout("params"),
]);
function addLiquidity(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
