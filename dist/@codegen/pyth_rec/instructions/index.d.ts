...
export type { RequestGovernanceAuthorityTransferArgs, RequestGovernanceAuthorityTransferAccounts, } from "./requestGovernanceAuthorityTransfer";
...
export type { SetDataSourcesArgs, SetDataSourcesAccounts, } from "./setDataSources";
...
export type { SetWormholeAddressArgs, SetWormholeAddressAccounts, } from "./setWormholeAddress";
export { setMinimumSignatures } from "./setMinimumSignatures";
export type { SetMinimumSignaturesArgs, SetMinimumSignaturesAccounts, } from "./setMinimumSignatures";
