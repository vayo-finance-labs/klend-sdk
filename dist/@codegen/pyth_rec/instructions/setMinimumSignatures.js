...
exports.setMinimumSignatures = setMinimumSignatures;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([5, 210, 206, 124, 43, 68, 104, 149]);
exports.layout = borsh.struct([
    borsh.u8("minimumSignatures"),
]);
function setMinimumSignatures(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=setMinimumSignatures.js.map