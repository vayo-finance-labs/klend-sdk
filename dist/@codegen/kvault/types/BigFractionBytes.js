...
exports.BigFractionBytes = void 0;
...
class BigFractionBytes {
    ...
    static fromJSON(obj) {
        return new BigFractionBytes({
            value: obj.value.map((item) => new bn_js_1.default(item)),
...
exports.BigFractionBytes = BigFractionBytes;
//# sourceMappingURL=BigFractionBytes.js.map