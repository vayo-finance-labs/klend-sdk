...
exports.DISCRIMINATOR = Buffer.from([122, 3, 21, 222, 158, 255, 238, 157]);
exports.layout = borsh.struct([
    types.VaultConfigField.layout("entry"),
    borsh.vecU8("data"),
]);
function updateVaultConfig(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=updateVaultConfig.js.map