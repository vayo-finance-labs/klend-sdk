...
exports.DISCRIMINATOR = Buffer.from([242, 35, 198, 137, 82, 225, 242, 182]);
exports.layout = borsh.struct([borsh.u64("maxAmount")]);
function deposit(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
