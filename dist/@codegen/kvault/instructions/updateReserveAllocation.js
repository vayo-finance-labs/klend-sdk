...
exports.updateReserveAllocation = updateReserveAllocation;
/* eslint-disable @typescript-eslint/no-unused-vars */
const kit_1 = require("@solana/kit");
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([5, 54, 213, 112, 75, 232, 117, 37]);
exports.layout = borsh.struct([
    borsh.u64("weight"),
    borsh.u64("cap"),
]);
function updateReserveAllocation(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=updateReserveAllocation.js.map