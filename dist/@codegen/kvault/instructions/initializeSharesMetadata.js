...
exports.initializeSharesMetadata = initializeSharesMetadata;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([3, 15, 172, 114, 200, 0, 131, 32]);
exports.layout = borsh.struct([
    borsh.str("name"),
    borsh.str("symbol"),
    borsh.str("uri"),
]);
function initializeSharesMetadata(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        {
...
//# sourceMappingURL=initializeSharesMetadata.js.map