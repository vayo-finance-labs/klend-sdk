...
exports.addUpdateWhitelistedReserve = addUpdateWhitelistedReserve;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const types = __importStar(require("../types")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([219, 139, 95, 204, 7, 183, 118, 45]);
exports.layout = borsh.struct([
    types.UpdateReserveWhitelistMode.layout("update"),
]);
function addUpdateWhitelistedReserve(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        {
...
//# sourceMappingURL=addUpdateWhitelistedReserve.js.map