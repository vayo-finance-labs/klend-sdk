...
exports.giveUpPendingFees = giveUpPendingFees;
...
function giveUpPendingFees(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        {
...
//# sourceMappingURL=giveUpPendingFees.js.map