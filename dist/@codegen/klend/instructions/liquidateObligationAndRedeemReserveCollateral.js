...
exports.DISCRIMINATOR = Buffer.from([177, 71, 154, 188, 226, 133, 74, 55]);
exports.layout = borsh.struct([
    borsh.u64("liquidityAmount"),
    borsh.u64("minAcceptableReceivedLiquidityAmount"),
    borsh.u64("maxAllowedLtvOverridePercent"),
]);
function liquidateObligationAndRedeemReserveCollateral(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        {
