...
exports.DISCRIMINATOR = Buffer.from([36, 119, 251, 129, 34, 240, 7, 147]);
exports.layout = borsh.struct([
    borsh.u8("elevationGroup"),
]);
function requestElevationGroup(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
