...
exports.setObligationOrder = setObligationOrder;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const types = __importStar(require("../types")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([81, 1, 99, 156, 211, 83, 78, 46]);
exports.layout = borsh.struct([
    borsh.u8("index"),
    types.ObligationOrder.layout("order"),
]);
function setObligationOrder(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=setObligationOrder.js.map