...
exports.withdrawObligationCollateralAndRedeemReserveCollateralV2 = withdrawObligationCollateralAndRedeemReserveCollateralV2;
/* eslint-disable @typescript-eslint/no-unused-vars */
const kit_1 = require("@solana/kit");
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([235, 52, 119, 152, 149, 197, 20, 7]);
exports.layout = borsh.struct([
    borsh.u64("collateralAmount"),
]);
function withdrawObligationCollateralAndRedeemReserveCollateralV2(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        {
...
//# sourceMappingURL=withdrawObligationCollateralAndRedeemReserveCollateralV2.js.map