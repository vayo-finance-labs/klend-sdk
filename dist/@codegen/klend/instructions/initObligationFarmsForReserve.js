...
exports.DISCRIMINATOR = Buffer.from([136, 63, 15, 186, 211, 152, 168, 164]);
exports.layout = borsh.struct([
    borsh.u8("mode"),
]);
function initObligationFarmsForReserve(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
