...
exports.DISCRIMINATOR = Buffer.from([129, 199, 4, 2, 222, 39, 26, 46]);
exports.layout = borsh.struct([
    borsh.u64("liquidityAmount"),
]);
function depositReserveLiquidityAndObligationCollateral(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
