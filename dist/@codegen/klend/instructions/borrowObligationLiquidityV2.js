...
exports.borrowObligationLiquidityV2 = borrowObligationLiquidityV2;
/* eslint-disable @typescript-eslint/no-unused-vars */
const kit_1 = require("@solana/kit");
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([161, 128, 143, 245, 171, 199, 194, 6]);
exports.layout = borsh.struct([
    borsh.u64("liquidityAmount"),
]);
function borrowObligationLiquidityV2(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        {
...
//# sourceMappingURL=borrowObligationLiquidityV2.js.map