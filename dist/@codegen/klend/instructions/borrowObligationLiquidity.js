...
exports.borrowObligationLiquidity = borrowObligationLiquidity;
/* eslint-disable @typescript-eslint/no-unused-vars */
const kit_1 = require("@solana/kit");
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([121, 127, 18, 204, 73, 245, 225, 65]);
exports.layout = borsh.struct([
    borsh.u64("liquidityAmount"),
]);
function borrowObligationLiquidity(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
