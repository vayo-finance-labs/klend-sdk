...
exports.depositObligationCollateral = depositObligationCollateral;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([108, 209, 4, 72, 21, 22, 118, 133]);
exports.layout = borsh.struct([
    borsh.u64("collateralAmount"),
]);
function depositObligationCollateral(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
