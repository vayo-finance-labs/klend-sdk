...
exports.withdrawObligationCollateral = withdrawObligationCollateral;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([37, 116, 205, 103, 243, 192, 92, 198]);
exports.layout = borsh.struct([
    borsh.u64("collateralAmount"),
]);
function withdrawObligationCollateral(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
