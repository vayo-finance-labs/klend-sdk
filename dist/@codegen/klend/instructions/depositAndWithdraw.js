...
exports.depositAndWithdraw = depositAndWithdraw;
/* eslint-disable @typescript-eslint/no-unused-vars */
const kit_1 = require("@solana/kit");
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([141, 153, 39, 15, 64, 61, 88, 84]);
exports.layout = borsh.struct([
    borsh.u64("liquidityAmount"),
    borsh.u64("withdrawCollateralAmount"),
]);
function depositAndWithdraw(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        {
        ...
        (0, kit_1.isSome)(accounts.depositFarmsAccounts.obligationFarmUserState)
            ? {
                address: accounts.depositFarmsAccounts.obligationFarmUserState.value,
                role: 1,
            }
            : { address: programAddress, role: 0 },
        (0, kit_1.isSome)(accounts.depositFarmsAccounts.reserveFarmState)
            ? {
                address: accounts.depositFarmsAccounts.reserveFarmState.value,
                role: 1,
            }
            : { address: programAddress, role: 0 },
        (0, kit_1.isSome)(accounts.withdrawFarmsAccounts.obligationFarmUserState)
            ? {
                address: accounts.withdrawFarmsAccounts.obligationFarmUserState.value,
                role: 1,
            }
            : { address: programAddress, role: 0 },
        (0, kit_1.isSome)(accounts.withdrawFarmsAccounts.reserveFarmState)
            ? {
...
//# sourceMappingURL=depositAndWithdraw.js.map